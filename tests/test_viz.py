...
from src.constants import ATTACK_NODE_COLOR, HARDENED_NODE_COLOR
from src.viz import build_node_layer, compute_node_emphasis
...
class TestComputeNodeEmphasis:
    ...
    def test_removed_nodes_are_attack_colored(self, simple_digraph):
        ...
        emphasis = compute_node_emphasis(
            simple_digraph, top_n=2, metric="degree", removed_nodes={"AAA"}
        )
    ...
    def test_hardened_nodes_are_hardened_colored(self, simple_digraph):
        ...
        emphasis = compute_node_emphasis(
            simple_digraph, top_n=2, metric="degree", hardened_nodes={"BBB"}
        )
...
class TestBuildNodeLayer:
    ...
    def test_includes_all_valid_nodes(self, simple_digraph):
        ...
        emphasis = {
            n: {"size": 50000, "color": [100, 100, 100], "is_emphasized": False}
